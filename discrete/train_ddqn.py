...
CONFIG = {
    ...
    "batchSize": 256,
    "optimizerLR": 1e-3,
    "policy_file": "weightsPth/DDQN_v1.pth",
}
...
class DDQN:
    ...
    def trainAgent(self):
        pbar = tqdm(range(self.MAX_TRAIN_EPISODES), desc="Training DDQN", unit="ep")
        for episode in pbar:
...
if __name__ == "__main__":
    ...
    print("Starting Double Deep Q-Learning...")
    final_reward = agent.runDDQN()
